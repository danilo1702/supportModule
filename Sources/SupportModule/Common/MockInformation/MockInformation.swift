...
public struct MockInformation {
    ...
    static let cardListZonas : [CardModel] = [
        CardModel(id: "1",image: ImageModel(image: "https://www.estrategiaynegocios.net/binrepository/1350x900/75c0/1200d900/none/26086/QUOJ/banco-industria-gt_1437769_20220502084737.jpg"), titleFormat: TextViewModel(text: "Banco IndustrialZona 13 Interior Combex Guatemala Agencia",foregroundColor: .black, font: .system(size: 14)), type: "text"),
        CardModel(id: "2", image: ImageModel(image: "https://www.corporacionbi.com/gt/bancoindustrial/wp-content/uploads/2020/09/1991.jpg", backgroundColor: .yellow), titleFormat: TextViewModel(text:" Banco Industrial Zona 14 Interior Camboa Guatemala Agencia",foregroundColor: .black, font: .system(size: 14)), type: "text"),
        CardModel(id: "1",image: ImageModel(image: "https://www.estrategiaynegocios.net/binrepository/1350x900/75c0/1200d900/none/26086/QUOJ/banco-industria-gt_1437769_20220502084737.jpg", backgroundColor: .pink), titleFormat: TextViewModel(text: "Banco IndustrialZona 15 Interior Combex Guatemala Agencia",foregroundColor: .black, font: .system(size: 14)), type: "text"),
        CardModel(id: "2", image: ImageModel(image: "https://www.corporacionbi.com/gt/bancoindustrial/wp-content/uploads/2020/09/1991.jpg", backgroundColor: .blue), titleFormat: TextViewModel(text:" Banco Industrial Zona 16  Camboa Guatemala Agencia",foregroundColor: .black, font: .system(size: 14)), type: "text")]
